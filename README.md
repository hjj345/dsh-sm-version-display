# sm-dsh-version-display — DeepSeek Harness 版本号显示插件
...
- 自适应布局：卡片文本宽度不足时自动换行（`overflow-wrap: anywhere`）；侧边栏折叠为窄栏（56px rail）时自动隐藏；
...
```text
sm-dsh-version-display-2026.08.23/
