...
`;
		...
		function BackupManager({ t, job }) {
			...
			const remove = async () => {
				...
				} catch (err) { if (revision === catalogRevision.current) setMessage(String(err.message)); } finally { finishRequest("delete"); }
			};
