...
`;
		...
		Object.assign(zh, { "settings.githubRateLimited": "GitHub API 暂时限流，已尝试备用 Feed", "settings.githubUnavailable": "GitHub 检测暂时不可用", "settings.checkChannel": "检测通道", "settings.feed.api": "GitHub API", "settings.feed.atom": "GitHub Releases Feed" });
		Object.assign(en, { "settings.githubRateLimited": "GitHub API is rate-limited; the fallback feed was also unavailable", "settings.githubUnavailable": "GitHub check is temporarily unavailable", "settings.checkChannel": "Check channel", "settings.feed.api": "GitHub API", "settings.feed.atom": "GitHub Releases Feed" });
		Object.assign(zhTW, { "settings.githubRateLimited": "GitHub API 暫時受限流，備用 Feed 也無法使用", "settings.githubUnavailable": "GitHub 檢測暫時無法使用", "settings.checkChannel": "檢測通道", "settings.feed.api": "GitHub API", "settings.feed.atom": "GitHub Releases Feed" });
