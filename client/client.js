...
`;
		...
		async function requestUpdateAction(action) {
			...
			try {
				...
				const payload = await response.json().catch(() => ({}));
				if (!response.ok || payload.ok !== true) throw new Error("update action failed");
				publish(updateStore, { status: "running", job: payload.job, error: null });
				startUpdatePolling(payload.job.id);
			} catch (error) {
				publish(updateStore, { status: "error", job: { ...job, lines: [...(job.lines ?? []), String(error.message ?? error)] }, error });
			}
		}
		...
		Object.assign(zh, { "settings.githubRateLimited": "GitHub API 暂时限流，已尝试备用 Feed", "settings.githubUnavailable": "GitHub 检测暂时不可用", "settings.checkChannel": "检测通道", "settings.feed.api": "GitHub API", "settings.feed.atom": "GitHub Releases Feed", "settings.openRelease": "点击一键直达", "settings.step.backup": "备份当前 DSH 环境", "settings.step.preflight": "预检目标版本", "settings.step.repair": "修复全局依赖树", "settings.step.install": "安装目标 DSH 版本", "settings.step.profileRepair": "修复 Web profile", "settings.step.verify": "校验安装结果和 profile", "settings.step.running": "执行中", "settings.step.success": "已完成", "settings.step.error": "失败", "settings.step.pending": "等待中", "settings.step.skipped": "已跳过", "settings.backupPath": "备份路径", "settings.backupFiles": "备份文件", "settings.peerWarnings": "检测到 peer dependency 警告，请重启 DSH 后确认功能。", "settings.updateFailed": "更新未完成，请选择自动修复或一键回滚。", "settings.manualRepair": "如果自动修复仍失败，请根据上方命令输出处理具体错误。", "settings.heartbeatTimeout": "超过 10 分钟未收到升级进度", "settings.heartbeatHelp": "Worker 可能仍在处理，也可能已经异常。请选择继续等待、自动修复或一键回滚。", "settings.continueWaiting": "继续等待", "settings.updateBoard": "更新执行看板", "settings.targetVersion": "预期更新版本", "settings.noCommand": "当前步骤没有命令输出，正在处理文件…", "settings.repair": "自动修复", "settings.rollback": "一键回滚", "settings.repairing": "正在修复…", "settings.rollingBack": "正在回滚…", "settings.rollbackFinished": "回滚完成，请重启 DSH。", "settings.repairFinished": "修复完成，请重启 DSH。", "settings.actionUnavailable": "当前没有可执行的操作。" });
		Object.assign(en, { "settings.githubRateLimited": "GitHub API is rate-limited; the fallback feed was also unavailable", "settings.githubUnavailable": "GitHub check is temporarily unavailable", "settings.checkChannel": "Check channel", "settings.feed.api": "GitHub API", "settings.feed.atom": "GitHub Releases Feed", "settings.openRelease": "Click to open", "settings.languageLabel": "语言/Language", "settings.step.backup": "Back up the current DSH environment", "settings.step.preflight": "Preflight the target version", "settings.step.repair": "Repair the global dependency tree", "settings.step.install": "Install the target DSH version", "settings.step.profileRepair": "Repair the Web profile", "settings.step.verify": "Verify the installation and profile", "settings.step.running": "Running", "settings.step.success": "Complete", "settings.step.error": "Failed", "settings.step.pending": "Pending", "settings.step.skipped": "Skipped", "settings.backupPath": "Backup path", "settings.backupFiles": "Backup files", "settings.peerWarnings": "Peer dependency warnings were detected; confirm functionality after restarting DSH.", "settings.updateFailed": "The update did not finish. Choose auto repair or rollback.", "settings.manualRepair": "If auto repair still fails, use the command output above to resolve the specific error.", "settings.heartbeatTimeout": "No upgrade progress has been received for 10 minutes", "settings.heartbeatHelp": "The Worker may still be processing or may have stopped unexpectedly. Choose continue waiting, auto repair, or rollback.", "settings.continueWaiting": "Continue waiting", "settings.updateBoard": "Update dashboard", "settings.targetVersion": "Target version", "settings.noCommand": "This step has no command output; files are being processed…", "settings.repair": "Auto repair", "settings.rollback": "Rollback", "settings.repairing": "Repairing…", "settings.rollingBack": "Rolling back…", "settings.rollbackFinished": "Rollback complete. Restart DSH.", "settings.repairFinished": "Repair complete. Restart DSH.", "settings.actionUnavailable": "No action is currently available." });
		Object.assign(zhTW, { "settings.githubRateLimited": "GitHub API 暫時受限流，備用 Feed 也無法使用", "settings.githubUnavailable": "GitHub 檢測暫時無法使用", "settings.checkChannel": "檢測通道", "settings.feed.api": "GitHub API", "settings.feed.atom": "GitHub Releases Feed", "settings.openRelease": "點擊一鍵直達", "settings.step.backup": "備份目前 DSH 環境", "settings.step.preflight": "預檢目標版本", "settings.step.repair": "修復全域依賴樹", "settings.step.install": "安裝目標 DSH 版本", "settings.step.profileRepair": "修復 Web profile", "settings.step.verify": "校驗安裝結果和 profile", "settings.step.running": "執行中", "settings.step.success": "已完成", "settings.step.error": "失敗", "settings.step.pending": "等待中", "settings.step.skipped": "已跳過", "settings.backupPath": "備份路徑", "settings.backupFiles": "備份檔案", "settings.peerWarnings": "偵測到 peer dependency 警告，請重新啟動 DSH 後確認功能。", "settings.updateFailed": "更新未完成，請選擇自動修復或一鍵回滾。", "settings.manualRepair": "若自動修復仍失敗，請根據上方命令輸出處理具體錯誤。", "settings.heartbeatTimeout": "超過 10 分鐘未收到升級進度", "settings.heartbeatHelp": "Worker 可能仍在處理，也可能已經異常。請選擇繼續等待、自動修復或一鍵回滾。", "settings.continueWaiting": "繼續等待", "settings.updateBoard": "更新執行看板", "settings.targetVersion": "預期更新版本", "settings.noCommand": "目前步驟沒有命令輸出，正在處理檔案…", "settings.repair": "自動修復", "settings.rollback": "一鍵回滾", "settings.repairing": "正在修復…", "settings.rollingBack": "正在回滾…", "settings.rollbackFinished": "回滾完成，請重新啟動 DSH。", "settings.repairFinished": "修復完成，請重新啟動 DSH。", "settings.actionUnavailable": "目前沒有可執行的操作。" });
		const backupText = {
		...
		function remoteSettingsScope(remote) {
			...
			const unwrap = (response) => { if (!response?.ok) throw new Error("Plugin settings request failed"); return response.value; };
			const load = async () => {
				const document = unwrap(await remote.settings.describe());
				...
				if (migration && document.writable && Object.keys(migration).length > 0) {
					const saved = unwrap(await remote.settings.update(NS, migration, revision));
			...
			let ready = load().catch((error) => { snapshot = { ...snapshot, writable: false, error }; notify(); throw error; });
			const refresh = () => { ready = load().catch((error) => { snapshot = { ...snapshot, writable: false, error }; notify(); throw error; }); return ready; };
			const stopListening = typeof remote.$on === "function" ? remote.$on("settings/document-updated", (ns) => { if (ns === NS) void refresh().catch(() => {}); }) : undefined;
			return {
				getSnapshot: () => snapshot,
				subscribe: (listener) => { listeners.add(listener); return () => listeners.delete(listener); },
				dispose: () => { stopListening?.(); listeners.clear(); },
				set: async (field, next) => {
					...
					const saved = unwrap(await remote.settings.update(NS, { [field]: next }, revision));
					revision = saved.revision;
					snapshot = { value: decodeSettings(saved.value), writable: true };
					notify();
				}
		...
		function VersionCard({ wide, t, scope }) {
			...
			if (!wide) return h(Fragment, null, h(primitives.Tooltip, { label: tooltipText, side: "right", delayMs: 300, portal: true }, h("button", { type: "button", className: "dvd_railButton", "aria-label": "dsh-sm-version-display", onClick: () => setOverlayOpen(true) }, h(primitives.IconCodeOutlineRegular, { size: 18 }))), overlayElement, toastElement);
			return h(Fragment, null, h("div", { className: "dvd_seatRow" }, h(primitives.Tooltip, { label: tooltipText, side: "right", delayMs: 300, portal: true }, h("button", { type: "button", className: "dvd_pill", onClick: () => setOverlayOpen(true) }, h("span", { className: "dvd_statusDot", "data-state": statusState, "aria-hidden": "true" }), h("span", { className: "dvd_pillVersion" }, formatVersion(current)))), h(primitives.Tooltip, { label: t("refresh"), side: "right", delayMs: 300, portal: true }, h("button", { type: "button", className: "dvd_seatRefresh", "aria-label": t("refresh"), disabled: checking, onClick: handleRefresh }, refreshIcon))), overlayElement, toastElement);
		}
		...
		function UpdateOutputPanel({ state, t, onAction, onCopy, copiedCommand }) {
			...
			const backupInfo = job.backup?.root ? h("p", { className: "dvd-settings-source-hint" }, t("settings.backupPath"), ": ", job.backup.root, " · ", t("settings.backupFiles"), ": ", job.backup.phase === "scanning" ? String(job.backup.scannedFiles ?? 0) : String(job.backup.completedFiles ?? job.backup.files ?? "-"), " · ", job.backup.phase === "copying" ? String(job.backup.progress ?? 0) + "%" : job.backup.phase) : null;
		...
		async function backupRequest(suffix = "", body) {
			const response = await fetch("/api/dsh-sm-version-display/backups" + suffix, { method: body === undefined ? "GET" : "POST", headers: { accept: "application/json", "content-type": "application/json", "x-dsh-sm-version-display-token": window.__DSH_UPDATE_TOKEN__ ?? "" }, ...(body === undefined ? {} : { body: JSON.stringify(body) }), signal: AbortSignal.timeout(120000) });
			const payload = await response.json();
			if (!response.ok || payload.ok !== true) throw new Error(payload.error ?? payload.reason ?? "Backup request failed");
			return payload;
		}
		function formatBytes(value) {
			const bytes = Math.max(0, Number(value) || 0);
			const unit = Math.min(4, Math.floor(Math.log(bytes || 1) / Math.log(1024)));
			return (bytes / 1024 ** unit).toFixed(unit === 0 ? 0 : 2) + " " + ["B", "KiB", "MiB", "GiB", "TiB"][unit];
		}
		function BackupDialog({ title, onClose, children }) {
			const dialog = react.useRef(null);
			react.useEffect(() => { const previous = document.activeElement; dialog.current?.showModal(); return () => previous?.focus?.(); }, []);
			return h("dialog", { ref: dialog, className: "dvd-settings-modal", "aria-label": title, onCancel: (event) => { event.preventDefault(); onClose(); }, style: { maxWidth: "min(680px, 90vw)", maxHeight: "85vh", overflow: "auto" } }, h("h2", null, title), children);
		}
		function DirectoryPicker({ initial, t, onSelect, onClose }) {
			const [path, setPath] = react.useState(initial ?? "");
			const [listing, setListing] = react.useState(null);
			const [error, setError] = react.useState("");
			const [busy, setBusy] = react.useState(false);
			const open = async (next) => { setBusy(true); setError(""); try { const result = await backupRequest("/directories?path=" + encodeURIComponent(next)); setListing(result); setPath(result.path); } catch (err) { setError(String(err.message)); } finally { setBusy(false); } };
			react.useEffect(() => { void open(initial ?? ""); }, []);
			return h(BackupDialog, { title: t("settings.backupDirectory"), onClose }, h("form", { className: "dvd-settings-directory-form", onSubmit: (event) => { event.preventDefault(); void open(path); } }, h("input", { "aria-label": t("settings.backupDirectory"), value: path, onChange: (event) => setPath(event.target.value) }), h("button", { className: "dvd-settings-secondary", type: "submit", disabled: busy }, t("settings.openDirectory"))), error ? h("p", { role: "alert" }, error) : null, h("button", { className: "dvd-settings-secondary", type: "button", disabled: busy || !listing?.parent, onClick: () => open(listing.parent) }, t("settings.parentDirectory")), h("ul", { className: "dvd-settings-directory-list" }, (listing?.directories ?? []).map((entry) => h("li", { key: entry.path }, h("button", { className: "dvd-settings-secondary dvd-settings-directory-pill", type: "button", disabled: busy, onClick: () => open(entry.path) }, entry.name)))), h("div", { className: "dvd-settings-modal-actions" }, h("button", { className: "dvd-settings-secondary", type: "button", onClick: onClose }, t("settings.cancel")), h("button", { className: "dvd-settings-primary", type: "button", disabled: busy || !listing || path !== listing.path, onClick: () => onSelect(listing.path) }, t("settings.useDirectory"))));
		}
		function BackupManager({ t, job }) {
			...
			const pendingRequests = react.useRef({ read: 0, scan: 0, delete: 0 });
			const catalogRevision = react.useRef(0);
			const deferredRefresh = react.useRef(false);
			const startRequest = (kind) => { pendingRequests.current[kind]++; setOperation(kind); setBusy(true); };
			const finishRequest = (kind) => { pendingRequests.current[kind] = Math.max(0, pendingRequests.current[kind] - 1); const pending = pendingRequests.current; setOperation(pending.delete ? "delete" : pending.scan ? "scan" : pending.read ? "read" : ""); setBusy(pending.delete + pending.scan + pending.read > 0); };
			const refresh = async (directory, keepMessage = false) => { if (pendingRequests.current.delete) { deferredRefresh.current = true; return; } const kind = directory ? "scan" : "read", revision = ++catalogRevision.current; startRequest(kind); if (!keepMessage) setMessage(""); try { const next = await backupRequest(directory ? "/scan" : "", directory ? { directory } : undefined); if (revision === catalogRevision.current) { setCatalog(next); setSelected((current) => current.filter((id) => next.backups.some((entry) => entry.id === id))); } } catch (err) { if (revision === catalogRevision.current) setMessage(String(err.message)); } finally { finishRequest(kind); } };
			react.useEffect(() => { void refresh(); }, [job?.id, job?.status]);
			react.useEffect(() => { const timer = window.setInterval(() => { void refresh(); }, 30 * 60 * 1000); return () => window.clearInterval(timer); }, []);
			const rows = catalog?.backups ?? [];
			const chosen = rows.filter((entry) => selected.includes(entry.id) && !entry.inUse);
			const total = formatBytes(chosen.reduce((sum, entry) => sum + (entry.sizeBytes ?? 0), 0));
			const remove = async () => {
				if (!chosen.length || !window.confirm(t("settings.backupDeleteConfirm", { count: chosen.length, size: total }))) return;
				const revision = ++catalogRevision.current;
				startRequest("delete");
				try {
					const result = await backupRequest("/delete", { ids: chosen.map((entry) => entry.id) });
					catalogRevision.current++;
					const deleted = new Set(result.deleted);
					setCatalog((current) => current && { ...current, backups: current.backups.filter((entry) => !deleted.has(entry.id)) });
					setSelected((current) => current.filter((id) => !deleted.has(id)));
					setMessage(t("settings.backupDeleted", { count: result.deleted.length }) + (result.errors ?? []).map((entry) => "\n" + entry.id + ": " + entry.error).join(""));
				} catch (err) { if (revision === catalogRevision.current) setMessage(String(err.message)); } finally { finishRequest("delete"); if (deferredRefresh.current) { deferredRefresh.current = false; void refresh(undefined, true); } }
			};
			return h("section", { className: "dvd-settings-card" }, h("h2", null, t("settings.backupTitle")), h("p", { className: "dvd-settings-description" }, t("settings.backupSizeNote")), h("div", { className: "dvd-settings-source-actions" }, h("button", { type: "button", disabled: busy, onClick: () => refresh() }, t("refresh")), h("button", { type: "button", disabled: busy, onClick: () => setPicker(true) }, t("settings.backupScan")), h("button", { type: "button", disabled: busy || !chosen.length, onClick: remove }, t("settings.backupDelete"))), h("p", null, t("settings.backupSelected", { count: chosen.length, size: total })), message ? h("p", { role: catalog ? "status" : "alert", style: { whiteSpace: "pre-wrap", overflowWrap: "anywhere" } }, message) : null, busy ? h("p", { role: "status" }, operation === "delete" ? t("settings.backupDelete") + "…" : operation === "scan" ? t("settings.backupScan") + "…" : t("settings.backupLoading")) : null, !busy && !message && !rows.length ? h("p", null, t("settings.backupEmpty")) : null, rows.map((entry) => h("label", { key: entry.id, className: "dvd-settings-backup-pill" }, h("input", { type: "checkbox", checked: chosen.some((item) => item.id === entry.id), disabled: busy || entry.inUse, onChange: (event) => setSelected((current) => event.target.checked ? [...current, entry.id] : current.filter((id) => id !== entry.id)) }), h("span", null, entry.createdAt ? new Date(entry.createdAt).toLocaleString() : entry.id, " · ", t("settings.backupStatus." + entry.status), " · ", formatBytes(entry.sizeBytes), h("div", null, formatVersion(entry.previousVersion), " → ", formatVersion(entry.version)), h("div", null, entry.path), entry.inUse ? h("strong", null, t("settings.backupInUse")) : null))), picker ? h(DirectoryPicker, { initial: catalog?.directory, t, onClose: () => setPicker(false), onSelect: (directory) => { setPicker(false); void refresh(directory); } }) : null);
		}
		function UpdateConfirmModal({ target, t, onConfirm, onClose }) {
			...
			const [picker, setPicker] = react.useState(false);
			const [error, setError] = react.useState("");
			react.useEffect(() => { let live = true; backupRequest().then((data) => { if (live) setDirectory(data.directory || data.defaultDirectory || ""); }).catch((err) => { if (live) setError(String(err.message)); }); return () => { live = false; }; }, []);
			...
			return h(BackupDialog, { title: t("settings.confirmTitle"), onClose }, h("p", null, t("settings.confirmTarget", { source: t("settings.source." + target.source), version: formatVersion(target.item.version), type: releaseTypeLabel(target.item.type, t) })), h("div", { className: "dvd-settings-confirm-warning" }, t("settings.confirmWarning")), h("label", null, h("input", { type: "checkbox", checked: enabled, onChange: (event) => setEnabled(event.target.checked) }), " ", t("settings.backupEnabled")), enabled ? h("div", null, h("label", null, t("settings.backupDirectory"), h("input", { value: directory, onChange: (event) => setDirectory(event.target.value), style: { width: "100%" } })), h("button", { type: "button", onClick: () => setPicker(true) }, t("settings.browse"))) : h("p", { role: "status", className: "dvd-settings-confirm-warning" }, t("settings.backupSkip")), error ? h("p", { role: "alert" }, error) : null, h("p", { className: "dvd-settings-update-command" }, definition.command), h("div", { className: "dvd-settings-modal-actions" }, h("button", { type: "button", className: "dvd-settings-secondary", onClick: onClose }, t("settings.cancel")), h("button", { type: "button", className: "dvd-settings-primary", disabled: enabled && !directory.trim(), onClick: () => onConfirm({ enabled, directory: directory.trim() }) }, t("settings.confirmUpdate"))), picker ? h(DirectoryPicker, { initial: directory, t, onClose: () => setPicker(false), onSelect: (value) => { setDirectory(value); setPicker(false); } }) : null);
		}
		...
		function VersionSettingsPage({ scope }) {
			...
			const handleOneClickUpdate = async (backupOptions) => {
				...
				try {
					const token = typeof window.__DSH_UPDATE_TOKEN__ === "string" ? window.__DSH_UPDATE_TOKEN__ : "";
					const response = await fetch(UPDATE_ROUTE, { method: "POST", headers: { accept: "application/json", "content-type": "application/json", "x-dsh-sm-version-display-token": token }, body: JSON.stringify({ source: target.source, version: target.item.version, backupOptions }), signal: AbortSignal.timeout(15000) });
					const payload = await response.json().catch(() => ({}));
			...
			const aboutRows = [
				...
				["settings.releaseDate", "2026-09-26"],
			...
			return h(Fragment, null, h("div", { className: "dvd-settings-page" }, hero, error !== null ? h("p", { className: "dvd-settings-error", role: "alert" }, t(error)) : null, general, h(BackupManager, { t, job: updateState.job }), about, install, h(UpdateOutputPanel, { state: updateState, t, onAction: requestUpdateAction, onCopy: copyCommand, copiedCommand })), modal, confirmModal);
		}
