...
if (!hostSrc.includes("export const Config = z.object(") || !hostSrc.includes(".default(\"zh\").volatile()") || !hostSrc.includes(".default(true).volatile()") || !hostSrc.includes("settingsCtx.settings.configure({ auto: false })")) fail("新版 DSH 设置 Config/页面策略未正确声明");
...
const readmeChecks = [
	["README.md", [">= v0.1.7-rc.1", "engines.dsh", "v1.2.15", "2026-09-26", "images/sm-version-display-icon-outlined.png", "@hjj345345/dsh-sm-version-display", "README.en.md", "## 更新日志", "Jack·Huang", "jack698698@gmail.com"]],
	["README.en.md", [">= v0.1.7-rc.1", "engines.dsh", "v1.2.15", "2026-09-26", "images/sm-version-display-icon-outlined.png", "@hjj345345/dsh-sm-version-display", "README.md", "## Changelog", "Jack·Huang", "jack698698@gmail.com"]]
];
