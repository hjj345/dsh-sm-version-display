...
fetchImpl = () => Promise.resolve({ ok: true, json: async () => ({ ok: true, current: "1.2.18", npm: { status: "success", version: "1.2.18" }, github: { status: "success", version: "1.2.18" } }) });
...
assert.match(text(overlay), /v1\.2\.18/);
